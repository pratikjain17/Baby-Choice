                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="product_discountprice"
                                                        class="form-control" placeholder="Enter Discount Product Price">
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Sub Category Name or id</label>
                                                    <select class="form-control category_list"
                                                        ...
                                                        <option value="5">SPECIAL OFFER</option>
                                                        <option value="6">UNIQUE PRODUCTS</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-12">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="add-product-form" enctype="multipart/form-data" method="post"
                                        action="updateProduct.php?productid=<?php echo $productid ?>">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <label>Product Name</label>
