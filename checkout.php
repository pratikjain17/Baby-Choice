					...
					<div class="col-sm-6">
						<div class="check_lm clearfix">
							...
							<div class="checkout_1l3 clearfix">
								<hr>
								<div class="col-sm-6">
									<h5 class="mgt"><a href=" cart.php?usercart=<?php echo $_SESSION['userid'] ?>"><i class="fa fa-chevron-left"></i> Return to cart</a></h5>
								</div>
								<div class="col-sm-6">
						...
						?>
							...
							<div class="checkout_1r1 clearfix">
								...
								<div class="checkout_1r1i clearfix">
									...
									<div class="col-sm-6">
										<h4 class="mgt"><span class="normal">INR</span> <span class="col_3">Rs.<?php echo $_SESSION['cartBill']+60 ?></span></h4>
									</div>
								</div>
							</div> 
						</div>
